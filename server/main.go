...
func main() {
	...
	api.POST("/setup/agents/:id/auth/submit", srv.SubmitAgentAuthCode)
	api.POST("/setup/:id/auth/submit", srv.SubmitAgentAuthCode)
	...
	setupRoot.POST("/setup/:id/auth/submit", srv.SubmitAgentAuthCode)
